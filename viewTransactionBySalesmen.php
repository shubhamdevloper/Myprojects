...
<html>
	...
	<body style="background-image:url('background.jpg');">
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-dark">
		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
		    <div class="mr-auto nav-item">
			  <button class="btn btn-outline-light" data-toggle="modal" data-target="#customerListModalLong">Salesmen List</button>
			</div>
			  ...
			  <div class="modal-body">
				<table class="table table-striped">
				  <?php	
					  ...
					  <tbody>";
				    $customersresult = mysqli_query($link, "SELECT `S_ID`,`S_NAME` FROM `salesmen` WHERE `A_ID`= '".$_SESSION['UserName']."' ORDER BY S_NAME");
		...
		<div class="container" style="margin-top:20px;">
			<form method="post">
			  <div class="form-group row">
				<label class="col-sm-2 col-form-label"><b>Enter Salesmen Id</b></label>
				<input type="text" class="col-sm-4 form-control" placeholder="Enter Salesmen Id" name="S_ID">
			...
			<table class="table table-striped">
			  <?php	
				...
				if(array_key_exists('searchSubmit',$_POST))
				{
					...
					{
						$query = "select * from transaction where S_ID = '".$_POST['S_ID']."' and A_ID = '".$_SESSION['UserName']."' ORDER BY T_DATE";
					}
					else
					{
						$query = "select * from transaction where S_ID = '".$_POST['S_ID']."' and A_ID = '".$_SESSION['UserName']."' AND T_DATE >= '".$_POST['startSearchDate']."' AND T_DATE <= '".$_POST['endSearchDate']."' ORDER BY T_DATE";
					}
		...
		<div class="row">
			<div class="col">
				<p><label><b>Profit Done By Salesmen: </b></label><button class="btn btn-success" style="margin-left:20px;"><?php echo $Pamount;?></button></p>
			</div>
			<div class="col">
				<p><label><b>Gold Sold By Salesmen: </b></label><button class="btn btn-success" style="margin-left:20px;"><?php echo $Pgold;?></button></p>
			</div>
		</div>
