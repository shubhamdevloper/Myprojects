...
<html>
	...
	<body style="background-image:url('background.jpg');">
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-dark">
		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
		    <div class="mr-auto nav-item">
			  <button class="btn btn-outline-light" data-toggle="modal" data-target="#toSupplierListModalLong">To_Supplier List</button>
		...
		<form method="post">
			<div class="container">
				...
				<div class="form-group row">
					...
					<div class="col-sm-4"><input class="form-control" type="text" name="TS_ID" value="<?php if(isset($_POST['TS_ID'])) { echo htmlentities ($_POST['TS_ID']); }?>" placeholder="Enter To Supplier Id"></div>
		...
		<div class="container">
			<table class="table table-striped">
			  <?php	
				  ...
				  <tbody>";
				if(array_key_exists('TS_ID',$_POST))
				{
					$query = "select * from supplied where S_ID = '".$_POST['TS_ID']."' and A_ID = '".$_SESSION['UserName']."' ";
						...
						if (isset($row)) 
						{
							...
							if (isset($row))
							{
								...
								if(array_key_exists('add_Data',$_POST))
								{
									...
									{
										$query = " INSERT INTO `transaction` (`A_ID`, `TS_ID`, `S_ID`, `T_DATE`, `P_ID`, `AMOUNT`, `PAID`,`P_TYPE`,`P_WEIGHT`) VALUES ('".$_SESSION['UserName']."', '".$_POST['TS_ID']."', '".$_POST['S_ID']."','". $mydate ."','".$_POST['P_ID']."', '".$price."', '".$isPaid."','".$productTYPE."','".$productWEIGHT."'); ";
										...
										if($isPaid == 0)
										{
											$query = "UPDATE `supplied` SET `BILL PENDING`=".$billPending.",`BILL`=".$bill." WHERE `S_ID` = '".$_POST['TS_ID']."'";
										}
										else
										{
											$query = "UPDATE `supplied` SET `BILL`=".$bill." WHERE `S_ID` = '".$_POST['TS_ID']."'";
										}
										mysqli_query($link,$query);
		...
		<div class="modal fade" id="toSupplierListModalLong" tabindex="-1" role="dialog" aria-labelledby="customerListModalLongTitle" aria-hidden="true">
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  <div class="modal-header">
				<h5 class="modal-title" id="customerListModalLongTitle">To Supplier List</h5>
			  ...
			  <div class="modal-body">
				<table class="table table-striped">
				  <?php	
					  echo "<thead>
						<tr>
						  <th scope='col'>TS_ID</th>
						  <th scope='col'>TS_NAME</th>
						</tr>
					  </thead>
					  <tbody>";
